    ...
    @objc func flipCard(_ recognizer: UITapGestureRecognizer){
        ...
        case .ended:
            ...
            if let chosenCardView = recognizer.view as? PlayingCardView, faceUpCardViews.count < 2{
                ...
                UIView.transition(with: chosenCardView, duration:0.5, options: [.transitionFlipFromLeft], animations: {chosenCardView.isFaceUp = !chosenCardView.isFaceUp},completion: {
                    finished in
                    ...
                    if self.faceUpCardViewsMatch{
                        UIViewPropertyAnimator.runningPropertyAnimator(withDuration: 0.6, delay: 0, options: [], animations: {
                            ...
                            UIViewPropertyAnimator.runningPropertyAnimator(withDuration: 0.75, delay: 0, options: [], animations: {
                                ...
                                position in
                                cardsToAnimate.forEach{
                                    $0.isHidden = true//celelalte 2 nu sunt valabile
                                    $0.alpha = 1
